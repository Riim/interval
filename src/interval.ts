...
export function interval(value: number, unit: TUnit): number;
export function interval(value: `${number}${TUnit}`): number;
export function interval(value: number | string, unit?: TUnit) {
